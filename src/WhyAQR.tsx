    ...
    <main className="why-page">
      <section className="why-hero">
        <header className="why-topbar why-wrap">
          <button className="why-brand" onClick={onNavigateHome} type="button">
          ...
          <nav className="why-topnav" aria-label="Why AQR navigation">
            <button onClick={onNavigateHome} type="button">Home</button>
        ...
        <div className="why-wrap why-hero-inner">
          ...
          <div className="why-actions">
            <button className="why-button why-button-primary" onClick={onNavigateHome} type="button">
              Back to home
            </button>
      ...
      <section className="why-section why-section-silver" id="strong-route">
        <div className="why-wrap why-grid">
          ...
          <aside className="why-quote-panel">
            <p>“That is real math. And it matters.”</p>
          </aside>
        </div>
      </section>
