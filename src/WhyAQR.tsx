...
function WhyAQR({ onNavigateHome }: WhyAQRProps) {
  ...
  return (
    <main className="why-page" id="top">
        ...
        <div className="why-wrap why-grid">
          <div>
            ...
            <p>
              ...
              credits in quantitative reasoning. Michigan has a Quantitative Reasoning requirement. Notre Dame includes Quantitative Reasoning
      ...
      <section className="why-section why-section-silver why-image-section" id="students-image">
      ...
      <section className="why-section why-section-graphite" id="students-do">
      ...
      <section className="why-section why-section-black" id="preparation">
        <div className="why-wrap why-copy-block">
      ...
      <section className="why-section why-section-graphite" id="strong-route">
        <div className="why-wrap why-grid why-grid-wide">
          <div>
          ...
          <aside className="why-bottom-callout">
            ...
            <p>It is for students who should leave high school better able to think clearly, use tools well, and make sense of the world around them.</p>
