...
const PAGE_META: Record<Page, PageMeta> = {
  ...
  overview: { title: "Course Overview | Applied Quantitative Reasoning", description: "A clear overview of the AQR course structure, quarter projects, quantitative-reasoning themes, tools, prerequisites, and honors options." },
  q1: { title: "Quarter 1: Know Yourself | Applied Quantitative Reasoning", description: "Responsible AI use, learner support systems, misleading graphs, units, and useful revision." },
  q2: { title: "Quarter 2: Track Yourself | Applied Quantitative Reasoning", description: "Self-tracking, surveys, data displays, supported claims, sampling, bias, correlation, and causation." },
  q3: { title: "Quarter 3: Build a Decision Tool | Applied Quantitative Reasoning", description: "Criteria, tradeoffs, assumptions, weighting, risk, uncertainty, and testing." },
