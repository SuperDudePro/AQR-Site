      ...
      <section className="why-section why-section-silver" id="pathway">
        <div className="why-wrap why-grid">
          ...
          <aside className="why-callout">
            ...
            <p>
              AQR is not an isolated idea. It sits inside a larger movement toward applied quantitative reasoning,
              data literacy, modeling, and decision-making.
            </p>
          </aside>
        </div>
      </section>
      ...
      <section className="why-section why-section-light" id="colorado">
        <div className="why-wrap why-grid why-grid-wide">
          <div>
            ...
            <p>
              Colorado's draft high school math standards identify three advanced pathways in the later years of
              high school: <strong>quantitative reasoning</strong>, <strong>statistics</strong>, and
              <strong> advanced algebra/calculus</strong>. The Quantitative Reasoning Pathway is for students who want to
              connect mathematical concepts with practical applications, justify their reasoning, and evaluate quantitative arguments.
            </p>
            <p>
              That matters. It means this direction is not random, local, or made up. It is part of where serious
              math education is already going. AQR is built to prepare students for that kind of work.
            </p>
          </div>
          <div className="why-quote-panel">
            <p>"Most high school math courses are not designed primarily to prepare students for the Quantitative Reasoning Pathway. AQR is."</p>
          </div>
        </div>
      </section>
      ...
      <section className="why-section why-section-graphite">
        <div className="why-wrap why-grid why-grid-wide">
          <div>
            ...
            <p>
              Students track time and habits, analyze patterns, build decision tools, and learn how to evaluate
              claims, graphs, comparisons, and evidence. The goal is to help students get better at making sense of the world
              and making decisions with clearer reasoning.
            </p>
            <p>
              AQR is built with one common course structure and room for different levels of support, challenge,
              and independence. More specific details about the year structure can live on the main course page.
            </p>
          </div>
          <div className="why-mini-panel">
            ...
            <p>
              It gives students practice with the kind of thinking they will meet later in college, in work,
              and in adult life: weighing options, interpreting information, using digital tools, and making decisions with evidence.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="why-wrap why-grid why-grid-wide">
          <div>
            ...
            <p>
              ...
              and make decisions under uncertainty. Employers are moving in that direction as well. The World Economic Forum
              identifies analytical thinking as the top core skill for employers and points to AI and data skills as the fastest-growing skill areas over the next five years.
