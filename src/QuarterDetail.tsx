...
const quarterDetails: Record<QuarterPageKey, QuarterDetailRecord> = {
  q1: {
    ...
    fit:
      "This quarter introduces how AQR works: real tools, real workflow, and public-facing mathematical reasoning tied to useful outputs rather than abstract repetition.",
  },
  q2: {
  ...
  q3: {
    ...
    shortTitle: "Build a Decision Tool / App",
    ...
    fit:
      "This is not startup theater or coding prestige. The public-facing goal is a decision tool that actually works and makes its logic visible.",
  },
  q4: {
    ...
    <div className="quarter-site-shell">
      ...
      <header className="quarter-site-header quarter-hero">
        <div className="quarter-topbar quarter-wrap">
          ...
          <nav className="quarter-topnav" aria-label="Quarter page navigation" role="navigation">
            <a href="#" onClick={goHome}>Home</a>
            <a href="#/course-overview" onClick={goOverview}>Course Overview</a>
            <a href={`#/quarter-${quarter.slice(1)}`} aria-current="page">{detail.shortTitle}</a>
          </nav>
        </div>
      </header>
        ...
        <section className="quarter-section quarter-section-silver" aria-labelledby="quarter-focus-title">
          <div className="quarter-wrap quarter-grid">
            <div className="quarter-text-dark">
              <p className="quarter-section-kicker">Main public focus</p>
            ...
            <aside className="quarter-callout-panel">
              ...
              <p>
                This public page is only a shell for now. More details about the sequence, artifacts,
      ...
      <footer className="quarter-footer">
        <div className="quarter-wrap quarter-footer-inner">
          <p>Applied Quantitative Reasoning • Vista PEAK Prep • Quarter page • Updated April 21, 2026</p>
        </div>
      </footer>
    </div>
  );
