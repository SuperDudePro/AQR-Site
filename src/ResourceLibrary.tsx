...
const coreResources = [
  ...
  { title: "All Classroom Posters", kind: "Poster collection", href: "/classroom-posters/all", summary: "Every finished AQR poster design in one place." },
];
...
export default function ResourceLibrary() {
  ...
  const resources = useMemo(() => [
    ...
    ...publishedPosterTypes.flatMap((type) => type.posters.map((poster) => ({ title: poster.title, kind: "Poster", href: `/classroom-posters/${type.slug}`, summary: `${type.title}. ${poster.alt}` }))),
  ], []);
