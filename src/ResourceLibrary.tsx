...
const coreResources = [
  ...
  { title: "Student Guide and Expectations", kind: "Student resource", href: "/student-guide", summary: "Classroom routines, progress expectations, responsible tool use, discussion norms, language support, and getting help." },
